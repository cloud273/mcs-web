import 'package:clinic/api/clinic/clinic_appointment_reject_api.dart';
...
class AppointmentRejectPopupState extends State<AppointmentRejectPopup> {
  ...
  void _submit(BuildContext context) async {
    try {
      await ClinicAppointmentRejectApi(
      ...
      if (e == 403) {
        ...
        Alert.show(context,
            message: 'No_rejectable_appointment_message'.localized);
      } else {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: HeaderWidget(title: 'Reject_appointment_confirm'.localized),
      content: Container(
        width: 500,
        child: Form(
          key: _formKey,
